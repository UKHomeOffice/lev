Life Event Verification service
===

A service for verifying life events, such as births, deaths, and marriages in England and Wales.
...
```shell
pnpm install @ho-lev/your-new-package
```
